      ...
      <div className="grid grid-cols-6 gap-x-5 gap-y-12 mx-20 pb-20">
        ...
        {arr.map((item, index) => (
          <Link
            ...
            state={{ item: item }}
            key={index}
            className="hover:scale-110 transition duration-500 cursor-pointer bg-yellow-50 border-2 border-cyan-800 text-center font-bold p-5 h-[100px] rounded-xl flex flex-col relative justify-center items-center"
          >
            {item.done ? (
              <div>
